...
public class PortfolioManagerApplication {
  ...
  public static List<String> debugOutputs() {
     ...
     String resultOfResolveFilePathArgs0 = "/home/crio-user/workspace/alok-kumar-criodo-co-ME_QMONEY_V2/qmoney/bin/main/trades.json";
     String toStringOfObjectMapper = "com.fasterxml.jackson.databind.ObjectMapper@1573f9fc";
     String functionNameFromTestFileInStackTrace = "org.opentest4j.AssertionFailedError: expected: <[AAPL, MSFT, GOOGL]> but was: <[]>";
